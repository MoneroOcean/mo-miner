...
#define ROR(n, s)   do { \
		sph_u32 tmp[n]; \
		/* MOM PATCH BEGIN: ICX miscompiles the fixed-size overlapping memmove in this rotate; use the equivalent backwards word copy without disabling optimization. */ \
		unsigned u; \
